...
- **[Sobriété énergétique — Responsabilité écologique à l’IUT](projects/SobrieteEnergetique.md)**  
  Projet axé sur les enjeux environnementaux et l’optimisation des usages numériques.

- **[La Tour Maléfique Infernale — Jeu 2D en C++](projects/LTMI.md)**  
  Jeu 2D développé en C++ mettant en œuvre la logique de gameplay et la programmation orientée objet.
